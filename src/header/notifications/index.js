...
class NotificationArea extends React.Component{
    render(){
        ...
        <div className={styles.wrapper}>
            <button className={styles.icons} onClick={this.props.handleNewsClick}><span className={styles.unreadCount}><span>5</span></span><InfoLogo/></button>
            <button className={styles.icons} onClick={this.props.handleMsgClick}><span className={styles.unreadCount}><span>10</span></span><MsgLogo/></button>
            <button className={styles.avatar} onClick={this.props.handleAvatarClick}><img src='/imgs/avatar.jpg' alt="user's avatar"/></button>
    </div>)
    }
}

...
import {Follow, Hot, Recommend} from '../contents'
...
class Header extends React.Component{
	render(){
		...
		<div className={styles.twoHeads} style={{transform:this.props.scrollDown?'translateY(-52px)':'',transition: '300ms'}}>
			...
			<div className={styles.header2}>
				...
				<form className={styles.searchBarWrapper}>
					...
					<SearchButton />
					<input type='submit' value='提问' className={styles.askButton}/>
				</form>
			</div>
		</div>
	</div>)
